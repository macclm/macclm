  ...
  var e = {
      ...
      594: (e, t, s) => {
        ...
        async function n(e, t, s, n) {
          ...
          const i = Object.assign(Object.assign({}, n), { ignoreSearch: !0 }),
            c = await e.keys(t, i);
          for (const t of c) if (r === a(t.url, s)) return e.match(t, n);
        }
        s.d(t, { F: () => n }), s(913);
      },
      536: (e, t, s) => {
      ...
      194: (e, t, s) => {
        ...
        async function r(e, t) {
          let s = null;
          if (
            (e.url && (s = new URL(e.url).origin), s !== self.location.origin)
          )
        ...
        class l {
          ...
          async cachePut(e, t) {
            ...
            const { cacheName: u, matchOptions: d } = this._strategy,
              ...
              g = p
                ? await (0, a.F)(f, n.clone(), ["__WB_REVISION__"], d)
                : null;
            try {
              ...
              if (e instanceof Error)
                throw (
                  ("QuotaExceededError" === e.name && (await (0, r.Y)()), e)
                );
            }
      ...
      634: (e, t, s) => {
        ...
        async function w(e) {
          ...
          for (
            ...
            (a = t.find((t) => (e ? t.id === e : !s.has(t.id)))),
            !a);
      ...
      370: (e, t, s) => {
        s.r(t),
          s.d(t, { CacheExpiration: () => C, ExpirationPlugin: () => N }),
          s(524);
        var a = s(327),
          n = (s(120), s(125));
        let r, i;
        ...
        class N {
          constructor(e = {}) {
            (this.cachedResponseWillBeUsed = async ({
              ...
              e.purgeOnQuotaError &&
                (0, k.t)(() => this.deleteCacheAndMetadata());
          }
          _getCacheExpiration(e) {
            if (e === E.x.getRuntimeName())
              throw new n.V("expire-custom-caches-only");
            let t = this._cacheExpirations.get(e);
            return (
              t ||
                ((t = new C(e, this._config)),
          ...
          async _handleFetch(e, t) {
              ...
              });
            {
              const n = a.integrity,
                r = e.integrity,
                i = !r || r === n;
              (s = await t.fetch(new Request(e, { integrity: r || n }))),
                n &&
                  i &&
          ...
          self.addEventListener("activate", (e) => {
            ...
            e.waitUntil(
              (async (e, t = "-precache-") => {
                ...
                return (
                  await Promise.all(s.map((e) => self.caches.delete(e))), s
                );
              })(t).then((e) => {})
            );
          });
      ...
      362: (e, t, s) => {
        ...
        class i extends n._ {
          async _handle(e, t) {
            ...
            if (!s) throw new a.V("no-response", { url: e.url });
            return s;
          }
        }
        const c = {
  ...
  (s.n = (e) => {
    ...
    (() => {
      var e = s(89),
        ...
        i = s(634);
      const c = JSON.parse(
          '["maccl\\\\.org(?:/.*)?/ola/services/.*","maccl\\\\.org/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://06ade9ac-6f49-42fc-b859-257bd38b955a\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]'
        ).map((e) => new RegExp(e)),
        o = JSON.parse(
          '["maccl\\\\.org(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/06ade9ac-6f49-42fc-b859-257bd38b955a/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/06ade9ac-6f49-42fc-b859-257bd38b955a/feed"]'
        ).map((e) => new RegExp(e)),
        h = JSON.parse(
          '["/neighboring-masajid","/family-networking","/restaurants","/gas-stations","/","/professional-development","/health-advice","/how-to-pray","/upcoming-events","/prayer-timetable"]'
        ).map((e) => ({ url: e, revision: "1658375164702" }));
      self.addEventListener("activate", function (e) {
        e.waitUntil(
          caches.keys().then(function (e) {
            return Promise.all(
              e
                .filter((e) => e.startsWith("maccl.org-"))
        ...
        (0, e.registerRoute)(
          ({ url: e }) => c.some((t) => t.test(e.href)),
          new t.NetworkOnly()
        ),
        (0, r.precache)(h, { directoryIndex: null, cleanUrls: !1 }),
        (0, e.registerRoute)(
          ({ url: e }) => o.some((t) => t.test(e.href)),
          new t.NetworkFirst({
            cacheName: "network-first",
            plugins: [new a.CacheableResponsePlugin({ statuses: [200] })],
          })
        ),
        (0, e.registerRoute)(
          ({ request: e }) =>
            "style" === e.destination || "script" === e.destination,
          new t.StaleWhileRevalidate({
        ...
        (0, e.registerRoute)(
          ...
          new t.StaleWhileRevalidate({ cacheName: "google-fonts-stylesheets" })
        ),
        (0, e.registerRoute)(
          ...
          new t.CacheFirst({
            ...
            plugins: [
              new a.CacheableResponsePlugin({ statuses: [0, 200] }),
        ...
        (0, e.registerRoute)(
          ({ request: e }) =>
            "image" === e.destination || "font" === e.destination,
          new t.CacheFirst({
            cacheName: "images-fonts",
            plugins: [
              new a.CacheableResponsePlugin({ statuses: [200] }),
              new n.ExpirationPlugin({
                maxEntries: 100,
